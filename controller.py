...
def main():
    addr =  "C9:96:EB:8F:03:0B " #DC:7E:B8:5F:BF:46  C9:96:EB:8F:03:0B # CB:76:55:B9:54:67, CF:45:33:60:24:69 Mac-Adress of your AnkiCar -> sudo bluetoothctl -> Scan on -> Look for Anki car(Normally smth with with Anki... Drive 0')
